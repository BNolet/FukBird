	...
	function messageTextToSpeechHandler($msg, $usr) {
		...
		if($msg.text().length<250){
				...
				if (!hasTripple) {
                    ...
                    /* Special Username Handling for Special People >:D */
                    // For /u/Kretenkobr2
                    replaceStrList["Kretenkobr2"] = "KretenkobrTwo";
                    if (usr == "Kretenkobr2") { usr = "KretenkobrTwo";}
                    // For /u/741456963789852123
                    replaceStrList["741456963789852123"] = "7-41";
                    if (usr == "741456963789852123") { usr = "7 4 1"; } /* idea: if username is a lot of numbers, call them by the first 3 numbers seperated */
                    // For /u/Stjerneklar
                    replaceStrList["Stjerneklar"] = "StjerneKlarr";
                    if (usr == "Stjerneklar") { usr = "StjerneKlarr"; }
